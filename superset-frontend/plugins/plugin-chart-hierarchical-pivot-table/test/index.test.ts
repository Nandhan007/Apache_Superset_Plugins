 ...
 * under the License.
 */
import { HierarchicalPivotTableChartPlugin } from '../src';
 ...
 */
describe('@superset-ui/plugin-chart-hierarchical-pivot-table', () => {
  it('exists', () => {
    expect(HierarchicalPivotTableChartPlugin).toBeDefined();
  });
});
