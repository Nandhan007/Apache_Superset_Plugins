...
export default function RowLevelActionsControl({
  value = [],
  onChange,
  datasourceColumns = [],
  allColumns = [],
  hierarchyFields = [],
}: RowLevelActionsControlProps) {
  ...
  const handleOk = () => {
    form.validateFields().then(values => {
      ...
      if (Array.isArray(additionalFieldsList)) {
        ...
        for (const f of additionalFieldsList) {
          if (!f) continue;
                ...
                >
                  ...
                  >
                    {({ getFieldValue }) => {
                      ...
                      const uniqueField = getFieldValue('uniqueField');
                      ...
                      if (payloadMappingStr && payloadMappingStr.trim()) {
                        ...
                        if (uniqueField) {
                          previewObj[uniqueField] = 'sample_id_123';
                        }
