...
export const getCustomSortKey = (val, useCustomSorting) => {
    if ((!useCustomSorting && useCustomSorting !== true) || typeof val !== 'string') return val;
    ...
    const seasonNames = { spring: '01', summer: '02', fall: '03', autumn: '03', winter: '04' };
