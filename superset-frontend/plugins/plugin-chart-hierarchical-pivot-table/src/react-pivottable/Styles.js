...
export const Styles = styled.div`
  ${({ theme, isDashboardEditMode }) => css`
    ...
    table thead {
      // Use AntD semantic token for Table Header Background
      background-color: ${theme.colorBgContainer || '#ffffff'}; /* Ensure opaque base */
      background-image: linear-gradient(${theme.colorFillAlter || '#ededed'}, ${theme.colorFillAlter || '#ededed'}); /* Apply tint */
